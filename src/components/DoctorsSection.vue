  ...
  <section id="doctors" class="doctors-section py-20" ref="sectionRef">
    <v-container style="max-width: 1280px">
      <div class="text-center mb-14">
        ...
        <h2
          class="section-title text-h3 mt-3"
          :class="{ visible: inView, 'anim-title': true }"
        >
          Our Expert Doctors
        </h2>
        <p
          class="section-subtitle mt-4 mx-auto"
          :class="{ visible: inView, 'anim-sub': true }"
...
<style scoped>
  ...
  .doctor-card:hover {
    box-shadow: 0 24px 56px rgba(10, 110, 97, 0.18);
  ...
  .doctor-card:hover .photo-overlay {
    opacity: 1;
  }
  .doctor-socials {
    display: flex;
